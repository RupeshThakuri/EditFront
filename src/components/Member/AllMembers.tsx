...
const AllMembers = () => {
    return (
        <>
            <div className="container max-w-full flex items-center justify-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style={{ backgroundImage: "url('/images/members/mk.jpg')" }}></div>
                ...
                <div className="w-full lg:w-2/5">
                    ...
                    <Image src="/images/members/mk.jpg" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" width={500} height={600} alt='Img not found' />
                </div>
            </div>
